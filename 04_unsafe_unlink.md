...
Exploiting free on a corrupted chunk to get arbitrary write.
임의로 어떤 값을 쓰기 위해 올바르지 않은(깨진) 청크에 `free` 함수를 이용한다.
...
This technique can be used when you have a pointer at a known location to a region you can call unlink on.
이 기술은 당신이 unlink 함수를 호출할 수 있는 위치에 있는 포인터 중 주소값을 알고 있을 때 사용할 수 있다.
...
[Here (HITCON CTF 2014-stkof)](https://github.com/sunghun7511/Writeup/tree/master/ctf/), [And Here (Insomni'hack 2017-Wheel of Robots)](https://github.com/sunghun7511/Writeup/tree/master/ctf/)